...
public class DbInitializerService : IDbInitializerService
{
    ...
    {
        _connectionString = configuration.GetConnectionString("mngConnection")
            ?? throw new InvalidOperationException(
                "mngConnection 接続文字列が設定されていません。");
    ...
    public async Task ExecuteInitSqlAsync()
    {
        ...
        _logger.LogInformation("DB接続に成功しました。SQLを実行します...");
        ...
        _logger.LogInformation("DB初期化SQLの実行が完了しました。");
    }
